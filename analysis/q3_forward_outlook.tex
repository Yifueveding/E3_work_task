...
Our Q2c finding (interaction $\approx$ +0.04\%) reflected minimal solar clipping today. As solar
...
Standalone Storage           & \$75M  & \$1.7M  & $\sim$44 yrs \\
\textbf{Combined Solar + Storage} & \textbf{\$445M} & \textbf{\$20.5M} & \textbf{$\sim$22 yrs} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Caveat:} standalone storage looks uneconomic here ($\sim$44-year payback) purely because
